...
cache_server: obj/configuration.o obj/time_util.o obj/entry_header.o obj/hashmap.o obj/entry_hash_map.o obj/memory_queue.o obj/connection.o obj/connection_list.o obj/cache_server.o obj/main.o
	$(CC) -o bin/$@ $^ $(CFLAGS)
